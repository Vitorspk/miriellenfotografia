...
(function (a) {
    ...
    a.extend(a.validator, {
        ...
        messages: {
            ...
            digits: "Digite apenas digítos",
            creditcard: "Digite um numero de cartão de crédito válido",
            equalTo: "Digite o mesmo valor novamente",
            maxlength: a.validator.format("Não digite mais do que {0} caractéres"),
            minlength: a.validator.format("Digite pelo menos {0} caracteres"),
            rangelength: a.validator.format("Digite um valor entre {0} e {1} caractéres"),
            range: a.validator.format("Digite um valor entre {0} e {1}"),
            max: a.validator.format("Digite um valor igual ou menor que {0}"),
            min: a.validator.format("Digite um valor igual ou maior que {0}")
        },
